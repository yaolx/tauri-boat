...
const appUpdater = window?.xElectron?.appUpdater
const mainView = window?.xElectron?.mainView
function Setting() {
  ...
  const checkUpdate = () => {
    setLoading(true)
    appUpdater && appUpdater?.checkUpdate()
  }
  // 退出并安装更新
  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{ width: '300px!important', height: 300 }}
      >
